...
class DataAccess{
    ...
    func getMobile() -> [MobileModel]{
        ...
        let desc = """
                   ...
                   """
        mobiles.append(MobileModel(mobileCover: "face_recognition", mobileTitle: "FACE REKOGNITION", mobileDescription: desc, storyboardName: "faceRekognitionViewController"))
